...
def correct_essay(
    ...
    review = EssayReview(
        ...
        details_json={
            ...
            "strengths_cn": result["strengths_cn"],
            "issues": result["issues"],
            "issues_cn": result["issues_cn"],
            "suggestions": result["suggestions"],
            "suggestions_cn": result["suggestions_cn"],
            "corrected_title_cn": result["corrected_title_cn"],
            "corrected_text_cn": result["corrected_text_cn"],
...
def _serialize_review(review: EssayReview, asset_id: int, pdf_url: str) -> EssayCorrectionResponse:
    ...
    return EssayCorrectionResponse(
        ...
        corrected_title=review.corrected_title,
        corrected_title_cn=details.get("corrected_title_cn"),
        corrected_text=review.corrected_text,
        corrected_text_cn=details.get("corrected_text_cn"),
        summary=review.summary,
        summary_cn=details.get("summary_cn"),
        score=review.score,
        score_max=review.score_max,
        strengths=details.get("strengths", []),
        strengths_cn=details.get("strengths_cn", []),
        issues=details.get("issues", []),
        issues_cn=details.get("issues_cn", []),
        suggestions=details.get("suggestions", []),
        suggestions_cn=details.get("suggestions_cn", []),
